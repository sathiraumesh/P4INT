...
HOST_DETAILS = [
    {
        ...
        "port": 1,
        "subnet": "10.0.0.0/24",
        "gateway": {"ip": "10.0.0.254", "mac": "00:aa:bb:cc:00:ff"},
    },
    {
        "name": "h2",
        "ip": "10.0.0.2",
    ...
    },
    {
        ...
        "port": 1,
        "subnet": "10.0.1.0/24",
        "gateway": {"ip": "10.0.1.254", "mac": "00:aa:bb:cc:01:ff"},
    },
    {
        "name": "h4",
        "ip": "10.0.1.2",
    ...
    },
    {
        ...
        "port": 1,
        "subnet": "10.0.2.0/24",
        "gateway": {"ip": "10.0.2.254", "mac": "00:aa:bb:cc:02:ff"},
    },
    {
        "name": "h6",
        "ip": "10.0.2.2",
    ...
    },
    {
        ...
        "port": 1,
        "subnet": "10.0.3.0/24",
        "gateway": {"ip": "10.0.3.254", "mac": "00:aa:bb:cc:03:ff"},
    },
    {
        "name": "h8",
        "ip": "10.0.3.2",
    ...
    def build(self):
        ...
        for host in HOST_DETAILS:
            hosts[host["name"]] = self.addHost(
                host["name"], ip=f"{host['ip']}/24", mac=host["mac"]
            )
...
def main():
    ...
    for SWITCH in SWITCHES:
        ...
        sw.SetForwardingPipelineConfig(
            p4info=p4info_helper.p4info, bmv2_json_file_path="./build/ping.json"
        )
        ...
        for host in HOST_DETAILS:
            if host.get("subnet") == SWITCH.get("subnet"):
                table_entry = p4info_helper.buildTableEntry(
                    ...
                    action_params={"dstAddr": host["mac"], "port": host["port"]},
                )
